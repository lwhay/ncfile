...
public class ParallelGZIPEnvironment {
    ...
    public static ThreadPoolExecutor newThreadPoolExecutor(int nthreads) {
        ThreadPoolExecutor executor = new ThreadPoolExecutor(nthreads, nthreads, 1L, TimeUnit.SECONDS,
                new ArrayBlockingQueue<Runnable>(nthreads * 20), ThreadFactoryHolder.THREAD_FACTORY,

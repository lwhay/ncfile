...
public class ParallelGZIPOutputStream extends FilterOutputStream {
    ...
    private static int getThreadCount(ExecutorService executor) {
     ...
     *
     * @param out
     *            the eventual output stream for the compressed data.
     * @throws IOException
    ...
    public ParallelGZIPOutputStream(OutputStream out, ExecutorService executor) throws IOException {

...
public class ResolvingGrammarGenerator extends ValidatingGrammarGenerator {
                ...
                case ARRAY:
                    return Symbol.seq(
                            Symbol.repeat(Symbol.ARRAY_END,
                                    generate(writer.getElementType(), reader.getElementType(), seen)),
                            Symbol.ARRAY_START);
     ...
     * 
     * @param s
     *            The schema for encoding
     * @param n
     *            The Json node that has the value to be encoded.
     ...
     * @param s
     *            The schema for the object being encoded.
     * @param n
     *            The Json node to encode.
     * @throws IOException

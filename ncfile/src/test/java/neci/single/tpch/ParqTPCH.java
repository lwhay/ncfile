...
public class ParqTPCH {
    ...
    public static void Q01_FilteringScan(String[] args) throws IOException {
        ...
        readSupport.setRequestedProjection(conf, schema);
        readSupport.setAvroReadSchema(conf, schema);
    ...
    public static void Q03_FilteringScan(String[] args) throws IOException {
        ...
        while ((record = reader.read()) != null) {
            ...
            String mkts = record.get("c_mktsegment").toString();
    ...
    public static void Q10_FilteringScan(String[] args) throws IOException {
        ...
        while ((record = reader.read()) != null) {
            ...
            long ck = (long) record.get("c_custkey");
            String ckey = record.get("c_acctbal").toString().trim() + "|" + record.get("c_address").toString().trim()
                    + "|" + (int) record.get("c_nationkey") + "|" + record.get("c_comment").toString().trim();
    ...
    public static void Q18_FilteringScan(String[] args) throws IOException {
        ...
        while ((record = reader.read()) != null) {
            ...
            String c_name = record.get("c_name").toString();
            long c_ck = (long) record.get("c_custkey");
            List<Record> orders = (List<Record>) record.get(offsetOrders);
            for (Record order : orders) {
